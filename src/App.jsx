      ...
      return (
        <div className="min-h-screen max-w-[1600px] mx-auto border-x-4 border-black bg-grid-pattern">
          ...
          <nav className="flex justify-between items-center border-b-4 border-black bg-white sticky top-0 z-50">
            <div className="p-4 md:px-8 font-display font-black text-2xl tracking-tighter bg-black text-white h-full flex items-center hover:bg-n8n-red transition-colors cursor-pointer">
          ...
          <footer className="bg-black text-white p-8 md:p-12 border-t-4 border-black">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="flex gap-6 font-mono text-sm font-bold">
                <a href="#" className="hover:text-n8n-red hover:underline decoration-4 underline-offset-4">TERMOS</a>
                <a href="#" className="hover:text-n8n-red hover:underline decoration-4 underline-offset-4">PRIVACIDADE</a>
            ...
            <div className="mt-12 pt-8 border-t-2 border-gray-800 text-center font-mono text-xs text-gray-600">
              &copy; 2024 N8N MASTERY. NÃO AFILIADO AO N8N.IO GMBH.
            </div>
          </footer>
        </div>
      );
